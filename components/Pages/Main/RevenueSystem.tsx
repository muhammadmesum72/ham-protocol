      ...
      <div className="px-4 sm:px-6 md:px-12 lg:px-[100px] py-10 md:py-[100px] max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {revenueData.map((item, index) => (
            <div
              key={index}
              className="text-center overflow-hidden relative z-30 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 p-px drop-shadow-card sm:rounded-[32px]  rounded-2xl "
            >
              <div className="bg-[#EEF5FD]  h-full sm:rounded-[32px] rounded-2xl  flex flex-col items-center px-4 py-6 md:px-6 md:py-8 ">
                {item.img && (
                  <Image
                    src={item.img}
