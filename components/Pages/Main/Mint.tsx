...
import Nft1 from "@/public/main/Nfts/nft1.gif";
import Nft2 from "@/public/main/Nfts/nft2.gif";
import Nft3 from "@/public/main/Nfts/nft3.gif";
import Nft4 from "@/public/main/Nfts/nft4.gif";
          ...
          {nfts.map((nft, index) => (
            ...
            >
              ...
              <div className="py-3 space-y-1 text-center">
                ...
                <p className="text-[#3E8DE3] text-base md:text-lg">
                  {nft.price}
                </p>
              </div>
            </div>
