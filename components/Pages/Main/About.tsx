      ...
      <div className="flex flex-col md:flex-row items-center justify-center py-16 md:py-[124px] gap-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-6 flex-1">
          {[
            ...
            <div
            key={index}
              className={`bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 p-px max-w-[275px] md:max-w-[330px]  md:h-[300px] rounded-[32px] drop-shadow-card  ${
                index === 1 && "md:mt-8"
              } ${index === 2 && "md:mt-16"}`}
            >
              <div
                key={index}
                className={`relative w-full z-30 h-full  bg-[#EEF5FD] rounded-[32px] flex items-center justify-center  p-3 overflow-hidden mx-auto `}
              >
